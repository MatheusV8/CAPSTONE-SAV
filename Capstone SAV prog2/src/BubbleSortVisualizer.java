...
/**
 * Classe que visualiza o algoritmo Bubble Sort.
...
public class BubbleSortVisualizer extends JPanel {
    ...
    /**
     * Construtor para o visualizador de Bubble Sort.
     * @param numeros Lista de números a serem ordenados.
     * @param delay Tempo de delay entre os passos da ordenação.
     */
    public BubbleSortVisualizer(List<Integer> numeros, int delay) {
    ...
    /**
     * Método para ordenar os números usando o algoritmo Bubble Sort.
     * O método atualiza o gráfico em cada iteração para mostrar o progresso da ordenação.
     */
    public void ordenarNumeros() {
        int n = numeros.size(); // Número total de elementos na lista

        // Realiza a ordenação Bubble Sort
        for (int i = 0; i < n - 1; i++) {
            boolean trocou = false; // Flag para verificar se houve troca na iteração atual

            // Itera pela lista até o último elemento não ordenado
            for (int j = 0; j < n - i - 1; j++) {
                ...
                if (numeros.get(j) > numeros.get(j + 1)) {
                    ...
                    trocou = true; // Define a flag como verdadeira, indicando que houve uma troca
        ...
        JOptionPane.showMessageDialog(this, "Fim da ordenação em Bubble!");
    }
}
